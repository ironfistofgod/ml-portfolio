...
if (OUT_DIR / "prompts.txt").exists() and (OUT_DIR / "videos.txt").exists() and len(videos) > 0:
    print(f"Data already prepared: {len(videos)} videos at {OUT_DIR} — skipping download")
else:
